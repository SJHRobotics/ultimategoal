...
public class VuforiaNavTest extends LinearOpMode {
    ...
    // For our USB Webcam, CAMERA_CHOICE = BACK and PHONE_IS_PORTRAIT = false
    ...
    // ImageTarget trackables use mm to specify dimensions, so we must use mm as well
    ...
    private void initVuforia() {
        ...
        //Create parameter object, pass camera preview resource
        int cameraMonitorViewId = hardwareMap.appContext.getResources().getIdentifier("cameraMonitorViewId", "id", hardwareMap.appContext.getPackageName());
        //NOTE: If the camera preview isn't needed, remove the cameraMonitorViewId parameter
    ...
    public void runOpMode() {
        // Load navigation target data sets
        ...
        //Set position of perimeter navigation targets
        ...
        // Set position of tower goal target
        ...
        /*
        NOTE: Commented this out for now because we do not have an RC phone, will need to test if this makes a difference
        ...
        // Set constants for Camera's position
        final float CAMERA_FORWARD_DISPLACEMENT  = 4.0f * mmPerInch;   // eg: Camera is 4 Inches in front of robot-center
        final float CAMERA_VERTICAL_DISPLACEMENT = 8.0f * mmPerInch;   // eg: Camera is 8 Inches above ground
        final float CAMERA_LEFT_DISPLACEMENT     = 0;     // eg: Camera is ON the robot's center line

        // Set camera position by passing constants defined above
        ...
        /*
        *WARNING: Target Tracking starts immediately when INIT is pressed so the camera preview feature can be used on the DS.
        * Do not put any driving commands in the tracking loop
        * Uncomment the following line to restore LinearOpMode structure
         */
