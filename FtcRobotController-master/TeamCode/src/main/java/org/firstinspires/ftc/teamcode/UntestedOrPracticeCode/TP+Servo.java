...
public class  RobotTellyOp extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        ConveyorServo = harwareMap.get(Servo.class, "Conveyor Servo");
        ...
        while (opModeIsActive()) {
            ...
            if(gamepad1.b) {
                ...
                ServoPosition = 130;
            }// turning the shooting motors on and the pushing rings
            else{
                shooterRightMotor.setPower(0.0);
                shooterLeftMotor.setPower(0.0);
                 ServoPosition = 10;
            }//turning the shooting motors off
            if(ramp_up && gamepad1.y) {
                ConveyorServo.setPosition(130);
                ramp_up = !ramp_up;
            }//moving the conveyor belt up
            else if(!ramp_up && gamepad1.y) {
                ConveyorServo.setPosition(0);
                !ramp_up = ramp_up;

            }//move the conveyor down
            LoadingServo.setPosition(servoPosition);//Turning the servo.
